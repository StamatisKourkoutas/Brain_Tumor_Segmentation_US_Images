...
#parser.add_argument('--trainsize', type=int, default=60, help='training dataset size')
...
# build models
model = RAS()
# Optionaly uncomment this line to load a pretrained RAS model for transfer learning
#model.load_state_dict(torch.load('/content/drive/My Drive/models/RAS.v1.pth'))
model.cuda()
...
# dataset path
image_path = '../datasets/trainingnew/image/'
gt_path = '../datasets/trainingnew/mask/'
