...
def preprocess_image(pil_im, resize_im=True):
    ...
    # If image is grayscale add extra dimension of size 1
    if(im_as_arr.shape==(224,224)):
        im_as_arr = im_as_arr.reshape((224,224,1))
...
def get_params():
    ...
    returns:
        ...
        target_mask: Target mask for the image
